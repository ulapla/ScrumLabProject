                    ...
                    <table class="table border-bottom">
                        ...
                        <c:forEach var="plan" items="${plans}">
                            <tr class="d-flex">
                                ...
                                <td class="col-2 d-flex align-items-center justify-content-center flex-wrap"><a href="/app.delete/plan?id=${plan.id}" class="btn btn-danger rounded-0 text-light m-1">Usuń</a>
