...
<form action="/app.plan/details/deleteRecipe" method="post" class="padding-small text-center">
    <section class="dashboard-section">
        <div class="border-dashed view-height">
            <div class="container w-25">
                <form class="padding-small text-center">
                    <h1 class="text-color-darker">Czy na pewno chcesz usunąć?</h1>
                    <input type="hidden" value="${recipePlanId}" name="recipePlanId">
                    <button class="btn btn-danger rounded-0 pt-0 pb-0 pr-4 pl-4" type="submit" name="delete">Usuń</button>
                </form>
                <a href='<c:url value="${sessionScope.recipeDetailBackButton}"/>' class="btn btn-success rounded-0 pt-0 pb-0 pr-4 pl-4">Anuluj</a>
            </div>
        </div>
        </div>
    </section>
